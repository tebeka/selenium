...
var (
	selenium3Path          = flag.String("selenium3_path", "vendor/selenium-server-standalone-3.14.0.jar", "The path to the Selenium 3 server JAR. If empty or the file is not present, Firefox tests using Selenium 3 will not be run.")
	...
	geckoDriverPath        = flag.String("geckodriver_path", "vendor/geckodriver-v0.21.0-linux64", "The path to the geckodriver binary. If empty of the file is not present, the Geckodriver tests will not be run.")
	javaPath               = flag.String("java_path", "", "The path to the Java runtime binary to invoke. If not specified, 'java' will be used.")

	chromeDriverPath = flag.String("chrome_driver_path", "vendor/chromedriver-linux64-2.42", "The path to the ChromeDriver binary. If empty of the file is not present, Chrome tests will not be run.")
